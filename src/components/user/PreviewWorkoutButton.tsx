        ...
        <Dialog.Content className="fixed inset-x-0 bottom-0 select-none px-4 pb-12 data-[state=closed]:animate-content-hide data-[state=open]:animate-content-show">
          <div className="rounded-modal bg-white ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700/80">
            ...
            <div className="flex flex-col p-4">
              ...
              <Dialog.Close className="flex items-center justify-center gap-1 rounded-lg bg-slate-800 py-2 font-bold text-white active:bg-slate-600 dark:bg-white dark:font-extrabold dark:text-slate-600 active:dark:bg-slate-700 active:dark:text-white">
                Hide
                {HideIcon}
              </Dialog.Close>
            </div>
