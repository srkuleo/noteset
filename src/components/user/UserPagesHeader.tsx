...
export const UserPagesHeader = () => {
  return (
    <header className="fixed inset-x-0 top-0 z-10 bg-white px-4 pt-safe-top dark:bg-slate-900">
...
export const UserPagesSubHeadingWrapper = ({
  ...
  return (
    <div
      className={twMerge(
        "fixed inset-x-0 top-[77px] z-10 mt-safe-top flex items-center justify-between border-b border-slate-300/80 bg-white px-6 pb-4 pt-2 dark:border-slate-800 dark:bg-slate-900",
        className,
      )}
    >
      {children}
