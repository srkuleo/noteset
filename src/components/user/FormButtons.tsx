...
export const ConfirmLogOutButton = () => {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full rounded-b-modal border-t border-slate-400/40 p-3 font-manrope text-lg font-semibold text-green-500 focus:outline-none active:bg-slate-200 disabled:bg-slate-300/55 disabled:text-green-500/75 disabled:dark:text-green-800 disabled:dark:bg-slate-900/75 dark:border-slate-600 active:dark:bg-slate-600/90"
    >
