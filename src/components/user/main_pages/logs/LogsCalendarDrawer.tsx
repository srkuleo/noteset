  ...
  return (
    <Drawer.Root open={open} onOpenChange={setOpen} noBodyStyles disablePreventScroll>
      ...
      <Drawer.Portal>
        ...
        >
          <div className="rounded-t-lg+ bg-white pb-safe-bottom ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700/70">
            <div className="flex flex-col px-8 pt-2 pb-4">
