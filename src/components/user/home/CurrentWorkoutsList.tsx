...
import { DumbbellIcon } from "@/components/icons/user/dumbbell";
        ...
        <SwipeAction.Trigger className="flex items-center justify-between rounded-xl border border-slate-300/80 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <Link
              ...
              scroll={false}
              className="flex rounded-modal bg-gradient-to-r from-violet-400 to-violet-500 px-5 py-0.5 font-bold text-white shadow-md active:scale-90 active:from-violet-300 active:to-violet-400 dark:from-violet-500 dark:to-violet-600 dark:active:from-violet-700 dark:active:to-violet-800"
            >
              <DumbbellIcon />
