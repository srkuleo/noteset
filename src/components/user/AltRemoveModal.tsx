    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="data-[state=closed]:animate-content-hide data-[state=open]:animate-content-show fixed inset-x-0 bottom-4 space-y-4 px-4 py-4">
          ...
          <Dialog.Close className="w-full rounded-[10px] bg-white p-3 text-xl font-bold text-violet-500 active:bg-slate-200 dark:bg-slate-700 dark:text-violet-400 active:dark:bg-slate-600/90">
            Cancel
          </Dialog.Close>
        </Dialog.Content>
      </Dialog.Portal>
