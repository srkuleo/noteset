...
const SuccessToast = ({ message }: { message: string }) => {
  return (
    <div className="mb-12 flex items-center gap-4 rounded-xl bg-green-50 px-4 py-2 font-manrope text-green-600 shadow-md">
      <SuccessIcon />
...
const ErrorToast = ({ message }: { message: string }) => {
  return (
    <div className="mb-12 flex items-center gap-4 rounded-xl bg-red-50 px-4 py-2 font-manrope text-red-600 shadow-md">
      <ErrorIcon />
