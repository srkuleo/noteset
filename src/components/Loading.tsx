  ...
  return (
    <main className="mt-safe-top space-y-4 px-6 pt-[158px] pb-[97px]">
      {[1, 2, 3, 4, 5, 6].map((skeleton) => (
        <div
          key={skeleton}
          className="flex animate-pulse flex-col rounded-xl bg-white shadow-md dark:bg-slate-800"
        >
          <div className="flex items-center gap-2 p-6">
            <div className="w-[calc(100%-86px)] space-y-1">
              <div className="h-6 w-1/3 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-950/80" />
              <div className="h-3.5 w-2/5 animate-pulse rounded-lg bg-slate-100 dark:bg-slate-950/50" />
            </div>

            <div className="h-[28px] w-[78px] animate-pulse rounded-full bg-slate-200 dark:bg-slate-950/80" />
          </div>

          <div className="flex h-11 animate-pulse divide-x divide-slate-300 rounded-b-xl bg-slate-100 ring-1 ring-slate-300 ring-inset dark:divide-slate-700 dark:bg-slate-900 dark:ring-slate-700">
            <div className="flex-1 rounded-bl-xl" />
        ...
        {[1, 2, 3, 4, 5, 6].map((skeleton) => (
          ...
          >
            <div className="flex items-center gap-2 p-6">
              ...
              <div className="h-[28px] w-[63px] animate-pulse rounded-full bg-slate-200 dark:bg-slate-950/80" />
            </div>

            <div className="flex h-11 animate-pulse divide-x divide-slate-300 rounded-b-xl bg-slate-100 ring-1 ring-slate-300 ring-inset dark:divide-slate-700 dark:bg-slate-900 dark:ring-slate-700">
              <div className="flex-1 rounded-bl-xl" />
              <div className="w-[124px] rounded-br-xl" />
            </div>
          </div>
        ))}
      </main>
